...
<body class=" p-2 bg-dark">
    <div class="container bg-dark text-white mt-5 p-5 border border-primary">
        ...
        <div class="container my-4  ">
            <h5 class="display-9 text-center mb-4"> หากต้องการค้นหาพื้นที่ และดูข้อมูล
                โปรดคลิกที่ปุ่มค้นหาตำแหน่งเพื่อกรอกข้อมูล </h5>
            <div class="d-flex justify-content-center">
                ...
                <div class="modal-dialog ">
                    <div class="modal-content text-light bg-dark">
                        ...
                        <div class="modal-body ">
                            ...
                            <div>
                                <h5> ตำแหน่งบ้านของผู้จัดทำ </h5>
                                <h5> Lat = 9.5398113 </h5>
                                <h5> Long = 100.0406409 </h5>
                            </div>
                        </div>
    ...
    function Posts(x, y) {
        ...
        $.getJSON(url)
            .done((data) => {
                ...
                var dataDate = new Date(unix_timestamp * 1000);
                ...
                line += "<h2 class='accordion-header'><button class=' accordion-button collapsed text-light bg-secondary' data-bs-toggle='collapse' data-bs-target='#content1'aria-expanded='true'>Country : " + data.sys.country + "  (" + data.name + ")</button></h2>"
                line += "<div id='content1' class='collapse show text-light bg-dark'>"
                line += "<div class='accordion-body '>"
                line += "<img src='http://www.chillpainai.com/src/wewakeup/scoop/img_scoop/scoop/Samui1/opg-6.jpg'alt=''>"
                line += "<p class='mt-4' id='text-1'>สภาพอากาศ : " + data.weather[0].description + "</p>"
                line += "<p id='text-1'>อุณหภูมิ : " + temp.toFixed(2) + "°C</p>"
                line += "<p id='text-1'>ความชื้น : " + data.main.humidity + "%</p>"
                line += "<p id='text-1'>องศาลม : " + data.wind.deg + "°</p>"
                line += "<p id='text-1'>ความเร็วลม : " + data.wind.speed + " km/h</p>"
                line += "<p id='text-1'>ความดัน : " + data.main.pressure + " mmHg</p>"
                line += "<p id='text-1'>พระอาทิตย์ขึ้น : " + formattedTime_1 + "</p>"
                line += "<p id='text-1'>พระอาทิตย์ตก : " + formattedTime_2 + "</p>"
                line += "<p id='text-1'>ณ วันที่ : " + formattedTime + "</p>"
                line += "<p id='text-1'></p>"
                line += "</div>"
                line += "</div>"
                line += "</div>"
